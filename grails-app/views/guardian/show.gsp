...
<html>
    ...
    <body>
        ...
        <div id="show-guardian" class="content scaffold-show" role="main">
            ...
            <f:display bean="guardian" />
            <g:form resource="${this.guardian}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.guardian}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
