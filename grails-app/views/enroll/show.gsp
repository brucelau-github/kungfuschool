...
<html>
    ...
    <body>
        ...
        <div id="show-enroll" class="content scaffold-show" role="main">
            ...
            <f:display bean="enroll" />
            <g:form resource="${this.enroll}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.enroll}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
